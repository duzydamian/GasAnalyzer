...
/**
 * MeasurementVariable generated by hbm2java
 */
@SuppressWarnings( { "rawtypes", "serial" } )
public class MeasurementVariable implements java.io.Serializable
{
	...
	public MeasurementVariable( int id, String name )
	{
		this.id = id;
		this.name = name;
	}

	public MeasurementVariable( int id, String name, Set measurements )
	{
		this.id = id;
		this.name = name;
