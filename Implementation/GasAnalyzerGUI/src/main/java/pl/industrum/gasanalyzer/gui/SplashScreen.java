...
public class SplashScreen
{
	...
	public void open()
	{
		...
		industrumLogo.setImage( SWTResourceManager.getImage(
				SplashScreen.class,
		...
		imiueLogo.setImage( SWTResourceManager.getImage( SplashScreen.class,
		...
		zkiwpLogo.setImage( SWTResourceManager.getImage( SplashScreen.class,
		...
		polslLogo.setImage( SWTResourceManager.getImage( SplashScreen.class,
