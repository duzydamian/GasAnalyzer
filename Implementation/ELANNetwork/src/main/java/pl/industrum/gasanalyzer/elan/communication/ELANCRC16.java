...
public class ELANCRC16 {
    ...
    static int[] crc_table = new int[512];
    
	/**
	 * Creates a new ELANCRC16 object.
	 */
	public ELANCRC16() {
		super();
		crc_table[0] = 0x0;
	...
	public static int calculateCRC16(Queue<Integer> data)
	{		
		int k0 = 0xFFFF;
        for (int id : data)
        {        	
        	...
        	int flag;
        	k0 ^= id;
        	for (bitanzahl = 8; bitanzahl > 0; bitanzahl--) {
        		flag = k0 & 1;
        		k0 = k0 >> 1;
        		if(flag==1) {
        			k0 ^= 0xA001;
