\resizebox{260pt}{!}{
	...
	\node[bottom color=cyan!40, mynode, text width=12cm, text height=2.5cm, below=.75cm of gui] (elanNetwork) {Moduł ELAN Network}; 
	...
	\node[bottom color=cyan!40, mynode, text width=12cm, below=.75cm of elanNetwork] (rxtx) {Biblioteka RXTX}; 
	\node[bottom color=cyan!40, mynode, text width=12cm, below=.75cm of rxtx] (conv) {Konwerter RS485 $\Leftrightarrow$ USB};   		
	\node[bottom color=cyan!40, mynode, text width=12cm, below=.75cm of conv] (devices) {Urządzenia pomiarowe};	
